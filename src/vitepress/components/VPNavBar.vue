...
import ToggleTheme from '../../core/components/ToggleTheme.vue'
  ...
  <div class="VPNavBar">
    <div class="container">
      <router-link
        ...
        to="/"
        focusable="false">
        <img v-show="isDark" :src="config.logo?.dark" alt="logo">
        <img v-show="!isDark" :src="config.logo?.light" alt="logo">
      </router-link>
